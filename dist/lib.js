!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.ReactPhoneInput = t(require("react")))
    : (e.ReactPhoneInput = t(e.React));
})(this, function (e) {
  return (function (e) {
    var t = {};
    function r(n) {
    ...
    function (e, t, r) {
      (function (t) {
        ...
        var l,
          ...
          m = (l = /[^.]+$/.exec((h && h.keys && h.keys.IE_PROTO) || ""))
            ? "Symbol(src)_1." + l
            : "",
          y = d.toString,
          g = p.hasOwnProperty,
        ...
        (S.prototype.clear = function () {
          ...
          (j.prototype.delete = function (e) {
            var t = this.__data__,
              r = x(t, e);
            return !(
              r < 0 || (r == t.length - 1 ? t.pop() : C.call(t, r, 1), 0)
            );
          }),
      ...
      (function (t) {
        ...
        e.exports = function (e, t, n) {
          ...
          return (
            ...
            g(n) &&
              ((f = !!n.leading),
              (i = (d = "maxWait" in n) ? h(b(n.maxWait) || 0, t) : i),
    ...
    function (e, t, r) {
      (function (e, r) {
        ...
        var H,
          ...
          te = (H = /[^.]+$/.exec((ee && ee.keys && ee.keys.IE_PROTO) || ""))
            ? "Symbol(src)_1." + H
            : "",
          re = Y.toString,
          ne = X.hasOwnProperty,
        ...
        (ke.prototype.clear = function () {
          ...
          (xe.prototype.delete = function (e) {
            var t = this.__data__,
              r = Ne(t, e);
            return !(
              r < 0 || (r == t.length - 1 ? t.pop() : se.call(t, r, 1), 0)
            );
          }),
        ...
        var Ae,
          ...
          Pe =
            ...
            function (e, t) {
              ...
              for (
                var r = e.length, n = De ? r : -1, a = Object(e);
        ...
        function Re(e, t) {
          for (
            var r = 0, n = (t = He(t, e) ? [t] : Ke(t)).length;
            null != e && r < n;
                      ...
                      c || lt(e)
                        ...
                        : (function (e, t, r, n, a, o, c) {
                            switch (r) {
                              ...
                              case _:
                                var l = o & u;
                                if ((s || (s = U), e.size != t.size && !l))
                                  return !1;
                                var f = c.get(e);
                                if (f) return f == t;
                                (o |= i), c.set(e, t);
                                var m = $e(s(e), s(t), n, a, o, c);
                                return c.delete(e), m;
                              case S:
                    ...
                    (function (e, t, r, n, a, o) {
                      ...
                      for (var m = i; ++f < s; ) {
                        ...
                        var y = e[d],
                          g = t[d];
                        if (n)
                          var b = i ? n(g, y, d, t, e, o) : n(y, g, d, e, t, o);
                        if (!(void 0 === b ? y === g || r(y, g, n, a, o) : b)) {
                          h = !1;
                          break;
                        }
                        m || (m = "constructor" == d);
        ...
        function Ge(e) {
          if (
            ((r = (t = e) && t.constructor),
            (n = ("function" == typeof r && r.prototype) || X),
            t !== n)
          )
            return le(e);
          var t,
          ...
          for (var o in Object(e))
            ne.call(e, o) && "constructor" != o && a.push(o);
          return a;
        }
        function Ke(e) {
          return nt(e) ? e : Qe(e);
        ...
        function $e(e, t, r, n, a, o) {
          ...
          for (o.set(e, t), o.set(t, e); ++d < s; ) {
            var m = e[d],
              y = t[d];
            if (n) var g = c ? n(y, m, d, t, e, o) : n(m, y, d, e, t, o);
            if (void 0 !== g) {
              if (g) continue;
              p = !1;
              break;
        ...
        ((fe && qe(new fe(new ArrayBuffer(1))) != k) ||
          (de && qe(new de()) != g) ||
          (pe && "[object Promise]" != qe(pe.resolve())) ||
          (he && qe(new he()) != _) ||
          (me && "[object WeakMap]" != qe(new me()))) &&
          (qe = function (e) {
            var t = ae.call(e),
            ...
            o(
              [
                ...
                return (
                  ...
                  k(t.iso2, t.dialCode, t.hasAreaCodes),
                  r.length > 0 ? [t].concat(r) : [t]
                );
              })
            )
          ),
            ...
            function t(e) {
              ...
              !(function (e, t) {
                ...
                ((r = (function (e, t) {
                  return !t || ("object" !== s(t) && "function" != typeof t)
                    ? l(e)
                    : t;
                })(this, f(t).call(this, e))).deleteAreaCodes = function (e) {
                ...
                (r.formatNumber = function (e, t) {
                  ...
                  return (
                    (s = u
                      ? l.formattedText + l.remainingText.join("")
                      : l.formattedText).includes("(") &&
                      !s.includes(")") &&
                      (s += ")"),
                    s
                  );
                ...
                (r.cursorToEnd = function () {
                  var e = r.numberInputRef.current;
                  e.focus();
                ...
                (r.handleFlagDropdownClick = function () {
                  if (r.state.showDropdown || !r.props.disabled)
                    if (
                      r.state.preferredCountries.includes(
                      ...
                      r.setState(
                        {
                          ...
                          highlightCountryIndex:
                            r.state.preferredCountries.findIndex(function (e) {
                      ...
                      var e = r.props.disableAreaCodes
                        ? r.deleteAreaCodes(r.state.onlyCountries)
                        : r.state.onlyCountries;
                      r.setState(
                        {
                          showDropdown: !r.state.showDropdown,
                          highlightCountryIndex: r.props.disableAreaCodes
                ...
                (r.handleInput = function (e) {
                  ...
                  if (
                    !(e.target.value.replace(/\D/g, "").length > 15) &&
                    e.target.value !== r.state.formattedNumber
                  ) {
                    if (
                      (e.preventDefault
                        ? e.preventDefault()
                      ...
                      (!r.state.freezeSelection ||
                        r.state.selectedCountry.dialCode.length > i.length) &&
                        ((n = r.guessSelectedCountry(
                          i.substring(0, 6),
                          r.state.onlyCountries,
                          r.state.defaultCountry
                        )),
                        (a = !1)),
                        (t = r.formatNumber(i, n.format)),
                        (n = n.dialCode ? n : r.state.selectedCountry);
                    }
                    ...
                    r.setState(
                      ...
                      function () {
                        s > 0 && (u -= s),
                          ")" == t.charAt(t.length - 1)
                            ? r.numberInputRef.current.setSelectionRange(
                                t.length - 1,
                                t.length - 1
                              )
                            : u > 0 &&
                              c.length >= t.length &&
                              r.numberInputRef.current.setSelectionRange(u, u),
                          r.props.onChange &&
                            r.props.onChange(
                              r.state.formattedNumber,
                              r.getCountryData()
                            );
                      }
                    );
                ...
                (r.handleFlagItemClick = function (e) {
                  var t = r.state.selectedCountry,
                    ...
                    o =
                      a.length > 1
                        ? a.replace(t.dialCode, n.dialCode)
                        : n.dialCode,
                ...
                (r.handleInputFocus = function (e) {
                  r.numberInputRef.current &&
                    "+" === r.numberInputRef.current.value &&
                    r.state.selectedCountry &&
                    ...
                    switch (e.which) {
                      ...
                      case t.ENTER:
                        r.handleFlagItemClick(
                          r.state.onlyCountries[r.state.highlightCountryIndex],
                          e
                        );
                        break;
                      case t.ESC:
                ...
                (r.handleInputKeyDown = function (e) {
                  var t = r.props.keys;
                  e.which === t.ENTER && r.props.onEnterKeyPress(e),
                    r.props.onKeyDown && r.props.onKeyDown(e);
                }),
                ...
                (r.handleSearchChange = function (e) {
                  ...
                  r.setState({ searchValue: t });
                }),
                (r.getDropdownCountryName = function (e) {
                  return null != r.props.localization[e.name]
                    ? r.props.localization[e.name]
                    : null != r.props.localization[e.iso2]
                    ? r.props.localization[e.iso2]
                    : e.name;
                }),
                (r.getCountryDropdownList = function () {
                  var e,
                    ...
                    p = l.searchClass,
                    h = l.searchStyle,
                    y = l.searchPlaceholder,
                    g = r.state.preferredCountries.includes(
                      r.state.selectedCountry
                    ),
                    b = a.concat(i),
                  ...
                  var _ = C.map(function (e, t) {
                    ...
                    w = m.a.createElement("li", {
                      key: "dashes",
                      className: "divider",
                    });
                  a.length > 0 && _.splice(a.length, 0, w);
                  var j = S()(
                    (n((e = {}), r.props.dropdownClass, !0),
                    n(e, "country-list", !0),
                    n(e, "hide", !c),
                    e)
                  );
                ...
                (r.numberInputRef = m.a.createRef());
              var a = x.allCountries;
              e.regions && (a = r.filterRegions(e.regions, a)),
                0 !== Object.keys(e.masks).length &&
                  (a = r.insertMasks(e.masks, a));
              var u,
                c = r.excludeCountries(
                  r.getOnlyCountries(e.onlyCountries, a),
                  e.excludeCountries
                ),
              ...
              var h,
                y =
                  p.length < 2 &&
                  u &&
                  !p.replace(/\D/g, "").startsWith(u.dialCode)
                    ? u.dialCode
                    : "";
              h =
                "" === p && 0 === u
                  ? ""
                  : r.formatNumber(
                      (e.disableCountryCode ? "" : y) + p.replace(/\D/g, ""),
                      u.name ? u.format : void 0
                    );
              ...
              (a = [
                {
                  ...
                  value: function () {
                    (getShadowRoot() || document).addEventListener &&
                      ((getShadowRoot() || document).addEventListener(
                        "mousedown",
                ...
                },
                {
                  ...
                  value: function () {
                    (getShadowRoot() || document).removeEventListener &&
                      ((getShadowRoot() || document).removeEventListener(
                        "mousedown",
                        this.handleClickOutside
                      ),
                ...
                },
                {
                  ...
                  value: function (e) {
                    e.defaultCountry &&
                    e.defaultCountry !== this.state.defaultCountry
                      ? this.updateDefaultCountry(e.defaultCountry)
                      : e.value !== this.state.formattedNumber &&
                        this.updateFormattedNumber(e.value);
                  },
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (o.startsWith("+"))
                      (o = o.replace(/\D/g, "")),
                        (t = this.guessSelectedCountry(
                          o.substring(0, 6),
                          n,
                          a
                        )),
                        (i = this.formatNumber(o, t.format));
                    else {
                      var u =
                        (t =
                          ...
                          : "";
                      i = this.formatNumber(
                        (this.props.disableCountryCode ? "" : u) +
                          o.replace(/\D/g, ""),
                        t ? t.format : void 0
                      );
                    }
                    this.setState({ selectedCountry: t, formattedNumber: i });
                  },
                },
                {
                  key: "render",
                  value: function () {
                    var e,
                      ...
                      s = S()({ arrow: !0, up: i }),
                      l = S()(
                        (n((e = {}), this.props.inputClass, !0),
                        n(e, "form-control", !0),
                        n(
                          e,
                          "invalid-number",
                          !this.props.isValid(u.replace(/\D/g, ""))
                        ),
                        e)
                      ),
                      f = S()(
                        (n((t = {}), this.props.buttonClass, !0),
                        n(t, "flag-dropdown", !0),
                        n(t, "open-dropdown", i),
                        t)
                      ),
                        ...
                        Object.assign(
                          {
                            ...
                            fullWidth: !0,
                            error: !this.props.isValid(u.replace(/\D/g, "")),
                            type: "tel",
                          },
                      ...
                      m.a.createElement(
                        ...
                        m.a.createElement(
                          "div",
                          {
                            ...
                            title: o
                              ? "".concat(o.name, ": + ").concat(o.dialCode)
                              : "",
                          },
                          m.a.createElement(
                            "div",
                            { className: d },
                            !c && m.a.createElement("div", { className: s })
                          )
                        )
                      ),
                      m.a.createElement(
